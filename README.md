...
<a href=""><img src="https://img.shields.io/badge/LinkedIn-6D28D9?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=1a1a2e" /></a>
...
- 🧠 **AI/ML Integration** — designing systems around LLM APIs (Gemini), OCR pipelines (Google ML Kit), and adaptive learning algorithms (SM-2 spaced repetition)
- 📱 **Mobile Engineering** — Clean Architecture Flutter applications with maintainable, testable, scalable codebases
...
<img src="https://skillicons.dev/icons?i=python,java,dart,js,ts,cpp,c&theme=dark" />

<br/><br/>

**Frontend**

<img src="https://skillicons.dev/icons?i=react,nextjs,flutter,tailwind,html,css,redux&theme=dark" />
...
<img src="https://skillicons.dev/icons?i=gcp,aws,docker,git,github,vscode,postman,figma&theme=dark" />
...
|---|---|---|
| **LLM API Integration** | ⭐⭐⭐⭐⭐ | Production use of Gemini 1.5 Flash for content generation — summaries, key points, MCQs, short-answer generation |
| **OCR & Document Intelligence** | ⭐⭐⭐⭐☆ | Google ML Kit OCR pipelines for handwritten note digitization on Android |
| **Adaptive Learning Algorithms** | ⭐⭐⭐⭐☆ | SM-2 spaced repetition implementation for adaptive study scheduling |
| **RAG Systems** | ⭐⭐⭐☆☆ | Architecting a retrieval-augmented AI study buddy chatbot over a semester knowledge base |
| **Data Analytics & Visualization** | ⭐⭐⭐⭐☆ | Python analytics pipelines (Pandas, Matplotlib, Seaborn) for large-scale dataset correlation analysis |
| **AI-Assisted Content Generation** | ⭐⭐⭐☆☆ | Prompt engineering for AI video generation tools (Runway, Kling, ElevenLabs) with copyright-safe design |
...
A complete e-commerce web application with authentication, product reviews, ratings, and wishlisting functionality.

| Category | Details |
|---|---|
| **Stack** | React, Node.js, Express, MongoDB, JWT, Tailwind CSS |
| **Scale** | Multi-user product catalog with review and wishlist subsystems |
...
Built and shipped multiple full-stack web applications spanning e-commerce, logistics, and productivity tooling.

- Developed complete MERN-stack e-commerce platform with JWT-secured authentication
- Re-architected a logistics platform from PostgreSQL/Docker to Firebase to remove local infrastructure friction
- Built a real-time Kanban task manager using Socket.IO for collaborative state sync

`React` `Next.js` `Node.js` `Express` `MongoDB` `Firebase` `Socket.IO`

<br/>

**Data Analytics Contributor** · *Independent Research Project*
`Prior`

Conducted a large-scale analytics study on AI's impact on student academic outcomes.

- Built a full Python analytics pipeline with Matplotlib and Seaborn visualizations
- Identified that traditional study hours correlated more strongly with GPA change than GenAI usage hours
- Delivered findings through data-driven visual storytelling
...
![NPTEL](https://img.shields.io/badge/NPTEL%20Certified-8B5CF6?style=for-the-badge&logo=googlescholar&logoColor=white&labelColor=1a1a2e)

**Cisco**

![Cisco](https://img.shields.io/badge/Cisco%20Certified-1BA0D7?style=for-the-badge&logo=cisco&logoColor=white&labelColor=1a1a2e)
...
*"Engineering is the art of turning constraints into elegant, working systems."*
